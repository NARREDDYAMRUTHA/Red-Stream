      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:narreddy.ammu2005@gmail.com" class="contact-link">narreddy.ammu2005@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+917093370371" class="contact-link">+91 7093370371</a>
          </li>
        </ul>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            13/339E-D-1 pyramid nagar,<br>vempalli,Kadapa.
            </address>
          </a>
          </li>
          <li class="footer-item">
            ...
            <a href="tel:+917093370371" class="footer-link">+91 7093370371</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:narreddy.ammu2005@gmail.com" class="footer-link">narreddy.ammu2005@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
